/**
 * Agente de servicio para buscar fichas.
 * <pre>
 ...
 * Buscar fichas.
 *
 * @param {string} text - Texto de búsqueda de fichas.
 * @param {module:agent-card-search.searchCardAgentCallback} callback - Respuesta al buscar fichas.
 */
function searchCardAgent(text, callback) {
  axios
    .get(enviroment.serverUrl + "/card/search", {
      params: {
        text: text
      }
    })
...
export default searchCardAgent;
